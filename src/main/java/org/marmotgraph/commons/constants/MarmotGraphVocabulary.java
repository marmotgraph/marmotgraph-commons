...
public class MarmotGraphVocabulary {
    ...
    public static final String META_ORDER = META + "orderNumber";
    public static final String META_MAX_LENGTH = META + "maxLength";
    public static final String META_MIN_ITEMS = META + "minItems";
    public static final String META_MAX_ITEMS = META + "maxItems";
    public static final String META_MIN_VALUE = META + "minValue";
    public static final String META_MAX_VALUE = META + "maxValue";
    public static final String META_REGEX = META + "regex";
    public static final String META_SEARCHABLE = META + "property/searchable";
    public static final String META_TARGET_TYPES = META + "targetTypes";
    public static final String META_REQUIRED = META + "required";
    public static final String META_MARKDOWN = META + "markdown";
    public static final String META_VALIDATION = META + "validation";
    public static final String META_WARNING = META + "warning";
    public static final String META_SOURCE_TYPES = META + "sourceTypes";
    public static final String META_EMBEDDED_ONLY = META + "embeddedOnly";
    public static final String META_PROPERTY_UPDATES = META + "propertyUpdates";
    public static final String META_AUTO_RELEASE = META + "space/autorelease";
    public static final String META_ERROR_MESSAGE = META + "errorMessage";
    public static final String META_LABEL_PROPERTY = META + "type/labelProperty";
    public static final String META_DEFAULT_TARGET_TYPE = META + "defaultTargetType";
